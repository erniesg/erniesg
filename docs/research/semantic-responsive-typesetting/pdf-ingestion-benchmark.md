...
npm run pdf:benchmark:compare -- \
  ...
  --corpus-report-schema-policy v1.9-only \
...
`--corpus-report-schema-policy v1.9-only`; the comparator validates the complete
