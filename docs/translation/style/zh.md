...
Prefer concise editorial adaptation over reproducing every English metaphor. Ernie's approved title and description for the microdramas post are the house-style example:

- `Microdramas: The Sinking Market That Will Lift All Boats` → `微短剧：水涨船高的下沉市场`
- `How China's microdrama phenomenon is capturing billions in value by targeting overlooked demographics and creating new AI-driven content opportunities` → `中国微短剧如何服务被忽视的人群，并为 AI 内容生产打开数十亿美元机会`
