---
title: 教程：用 A.I. 空气打鼓
description: 以及一些关于 A.I.、神经音频合成、打碟、Taylor Swift 和闪亮新玩具（Erae II）能怎样结合的想法
...
<iframe alt="握拳空气打鼓" src="https://www.youtube.com/embed/J94q8T-4kxM?feature=oembed" aria-describedby="nvcyc7m9oek-figure-caption" allowfullscreen="true" style="width: 100%; aspect-ratio: 16 / 9; height: auto; border: 0; "></iframe>
...
<iframe alt="教程：用 A.I. 空气打鼓" src="https://www.youtube.com/embed/mQPkA5hxxko?feature=oembed" aria-describedby="nxc9ev8ownr-figure-caption" allowfullscreen="true" style="width: 100%; aspect-ratio: 16 / 9; height: auto; border: 0; "></iframe>

教程：用 A.I. 空气打鼓

# 114 行代码

注意：你需要把 [gesture\_recognizer.task](https://developers.google.com/mediapipe/solutions/vision/gesture_recognizer) 和想播放的 .mp3 文件放在与脚本相同的目录里，或者更新文件路径。我使用的声音文件，基本上是由一个我用马来鼓训练过的 [RAVE 模型](https://github.com/acids-ircam/RAVE) 生成的音频。我也计划写一篇教程，介绍如何用免费的 Google Colab 笔记本训练你自己的模型，所以敬请期待！
...
*最初发表于 PubPub：[erniesg.pubpub.org/pub/r2map92q](https://erniesg.pubpub.org/pub/r2map92q)。*
