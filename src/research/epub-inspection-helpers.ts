...
import { sha256Sync } from './epub-manifest-evidence'
import {
  comparableText,
  INLINE_SCHOLARLY_IDENTIFIER,
...
export function inspectAssetReceipts(
...
export function xhtmlIds(value: string, documentName: string) {
...
export function resolvedPackageHref(
...
export function validateInternalHrefs(
