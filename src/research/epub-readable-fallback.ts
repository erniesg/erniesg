...
import { validNoteReferences } from './epub-semantic-text'
import {
...
export const MAX_READABLE_FALLBACK_OPTIONAL_ASSETS_PER_BOOK = 64
...
export function isSolidFillVectorFragment(asset: PublicationAsset) {
  if (
