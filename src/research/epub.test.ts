...
describe('EPUB 3 export', () => {
  ...
  it.each([',', '˒'])(
    'links normalized superscript citation labels separated by %s without changing visible source glyphs',
    (separator) => {
      ...
      citationPaper.nodes = [
        {
          id: 'claim',
          type: 'paragraph',
          text: `Prior evidence${marker} supports the claim.`,
          inlineRuns: [
            {
      ...
      expect(content).toContain(
        `<a href="#reference-1" epub:type="biblioref" role="doc-biblioref">¹</a>${separator}<a href="#reference-2" epub:type="biblioref" role="doc-biblioref">²</a>`,
      )
