...
describe('PDF visual relationship line-scoped ownership', () => {
  ...
  it('retains disjoint source runs when adjacent line boxes overlap', async () => {
    const fixture = await partialEquationFixture()
    fixture.denominatorLine.runs[0].height = 0.0135
    fixture.proseLine.box.y = 0.5188
    fixture.proseLine.runs[0].y = 0.5188
