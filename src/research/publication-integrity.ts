...
const SCHOLARLY_REFERENCE_BASE_ATOM = String.raw`(?:[A-Za-z]?\d+(?:\.\d+)*(?:[A-Za-z])?|${CANONICAL_UPPER_ROMAN_IDENTIFIER}|[A-Za-z](?:\.\d+)*)`
const SCHOLARLY_REFERENCE_PANEL_BASE_ATOM = String.raw`(?:[A-Za-z]?\d+(?:\.\d+)*|${CANONICAL_UPPER_ROMAN_IDENTIFIER}|[A-Za-z](?:\.\d+)*)`
